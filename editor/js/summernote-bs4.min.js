...
!(function (t, e) {
                ...
                [
                  ...
                  e.title
                    ? '<div class="modal-header"><h4 class="modal-title">' +
                      e.title +
                      '</h4><button type="button" class="close" aria-label="Close" aria-hidden="true" id="note-icon-close"><i class="note-icon-close"></i></button></div>'
                    : "",
  ...
  function fecharModalImagem() {
    document.querySelector(".modal .note-modal").style.opacity = "0";
    document.querySelector(".modal .note-modal").style.display = "none";
  }
});
